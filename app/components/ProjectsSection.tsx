						...
						<div className="p-8">
							<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
								<div className="space-y-6">
									<div>
										<h3 className="text-2xl font-bold mb-4">Truck Fleet Managment Software</h3>
									...
									<div className="grid grid-cols-2 gap-6">
										<div>
											...
											<ul className="space-y-2 text-sm text-gray-400">
												<li>• React: Component-based UI library for building interactive interfaces.</li>
												<li>• TypeScript: Adds static typing to improve code reliability and scalability.</li>
												<li>• TailwindCSS: Utility-first CSS framework for modern, responsive design.</li>
												<li>• Tanstack Router: For client-side routing between views.</li>
											</ul>
										</div>
										<div>
											...
											<ul className="space-y-2 text-sm text-gray-400">
												...
												<li>• FastAPI dependencies to enforce authorization.</li>
								...
								<a href="https://truckfleet.dev" target="_blank" >
									<img src="/truckfleetdashboard.png" alt="Truck Fleet image" />
									</a>
								</div>
							</div>
						</div>
